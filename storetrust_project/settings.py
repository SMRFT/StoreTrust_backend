"""
Django settings for storetrust_project project.
...
SECRET_KEY = '9y&5gk1%^s955=a8-__6(^iuptytrth#*90yo8*k0t(zh(mjm*'
...
ROOT_URLCONF = 'storetrust_project.urls'
...
WSGI_APPLICATION = 'storetrust_project.wsgi.application'
...
DATABASES = {
    'default': {
        'ENGINE': 'djongo',
        'NAME': os.getenv("STORETRUST_DB_NAME"),
